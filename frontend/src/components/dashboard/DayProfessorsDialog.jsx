...
function DayProfessorsDialog({ open, onClose, selectedDay, professorSchedules, handleProfessorClick }) {
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ minHeight: loading ? '200px' : 'auto', padding: 0 }}>
        {loading ? (
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            {/* Timeline header with hours - FIXED at the top */}
            <Box
              sx={{
                display: 'flex',
                ...
                pb: 1,
                pt: 2,
                mb: 0.5, // Riduco lo spazio tra header e primo professore
                px: 3,
                position: 'sticky',
                top: 0,
                zIndex: 10,
            ...
            {/* Scrollable container for professor rows */}
            <Box
              sx={{
                overflowY: 'auto',
                maxHeight: '500px',
                px: 3,
                pt: 1.5, // Aggiungo un piccolo padding in alto
                pb: 2,
                flex: 1
              }}
            >
